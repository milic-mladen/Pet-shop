...
import domen.Kupac;
import models.TableModelKupci;

/**
 *
 * @author User
 */
public class FormPretragaKupca extends javax.swing.JDialog {

    public FormPretragaKupca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        TableModelKupci model = new TableModelKupci();
        Thread th = new Thread(model);
        th.start();
        tblKupci.setModel(model);
        setTitle("Pretraga kupca");
    }
    ...
    private void initComponents() {
        ...
        btnDetalji.setText("Detalji kupca");
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((TableModelKupci) tblKupci.getModel()).setParametar(param);
    }//GEN-LAST:event_txtPretragaKeyReleased

    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        int row = tblKupci.getSelectedRow();
        if (row >= 0) {
            Kupac k = ((TableModelKupci) tblKupci.getModel()).getSelectedKupac(row);
            new FormDetaljiKupca(this, rootPaneCheckingEnabled, k).setVisible(true);
        }
    ...
    void refreshTable() {
        TableModelKupci tm = (TableModelKupci) tblKupci.getModel();
        tm.refreshTable();
    }
