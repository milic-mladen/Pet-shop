...
public class FormDetaljiProizvoda extends javax.swing.JDialog {
    ...
    /**
     * Creates new form FormDetaljiProizvoda
     */
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(btnIzmeniProizvod, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnIzmeniProizvodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzmeniProizvodActionPerformed
        try {
            ...
            Proizvod proizvod = new Proizvod(this.proizvod.getProizvodID(), naziv, opis, cena, kategorija, dobavljac);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDetaljiProizvoda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormDetaljiProizvoda dialog = new FormDetaljiProizvoda(new JDialog(), true, null);
    ...
    private void popuniKategorije() {
        try {
            ...
            cmbKategorija.getModel().setSelectedItem(this.proizvod.getKategorija());
        } catch (Exception ex) {
    ...
    private void popuniDobavljace() {
        try {
            ...
            cmbDobavljac.getModel().setSelectedItem(this.proizvod.getDobavljac());
        } catch (Exception ex) {
            Logger.getLogger(FormNoviProizvod.class.getName()).log(Level.SEVERE, null, ex);
        }
